...
youtube_auth1='usse-0e3k-6qjr-53bh-5bab'
...
twitch_streamkey='live_157756298_YKuHdqiKwSm3gCOLc3Z6FBElJ7SXwq'
...
case $1 in
  you|you1|you2|youtube|youtube1|youtube2)
        ...
        location=$serverurl'/'$auth'?videoKeyframeFrequency=1&totalDatarate='$datarate' app='$youtube_app' flashVer='$flashver' swfUrl='$serverurl
        ;;
  ustream)
